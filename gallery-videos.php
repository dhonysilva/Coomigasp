...
/**
 * Galeria de Vídeos
 * @author Dhony Silva <dhony.web@gmail.com>
 * @link http://about.me/dhony
 */
class GalleryVideos extends WP_Widget {
	/** constructor */
	function GalleryVideos() {
	    parent::WP_Widget(false, $name = 'Galeria de Vídeos');	
	}
	...
	function widget($args, $instance) {		
	   ...
	   //Fetch the category for the widget
		    $post_args = array('numberposts' => '4', 'offest' => 0, 'orderby' => 'post_date', 'order' => 'DESC','cat' => $use_catId->term_id);
...
add_action('widgets_init', create_function('', 'return register_widget("GalleryVideos");'));
?>